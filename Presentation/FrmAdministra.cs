...
{
    public partial class FrmAdministra : Form
    {

        public int Opcion;
        private IEstudianteService estudianteService;
       
        public FrmAdministra(IEstudianteService estudianteService)
        {
        ...
        private void NoDigit(object sender, KeyPressEventArgs e)
        {
